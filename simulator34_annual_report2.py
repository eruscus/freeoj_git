...
def update_earnings(parameters, i):
    ...
    # Sales Revenue
    if (product == 'ORA'):
        add_value_to_cell(quantity*price/.0005, earnings, 'Fresh Oranges (ORA)', 'Value')
    if (product == 'POJ'):
        add_value_to_cell(quantity*price/.0005, earnings, 'Premium Orange Juice (POJ)', 'Value')
    if (product == 'ROJ'):
        add_value_to_cell(quantity*price/.0005, earnings, 'Reconstituted Orange Juice (ROJ)', 'Value')
    if (product == 'FCOJ'):
        add_value_to_cell(quantity*price/.0005, earnings, 'Frozen Concentrated Orange Juice (FCOJ)', 'Value')
    add_value_to_cell(quantity*price/.0005, earnings, 'Total Revenue', 'Value')
