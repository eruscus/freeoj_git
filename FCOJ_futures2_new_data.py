...
#    plant_week = get_plant_week(product, demand_week)
    ...
    print('Product: ' + product + ', Month: ' + demand_month + ', Region: ' + region + ', Year Used = ' + str(year_used) + ', Price = ' + str(price))
...
def get_plant_week(product, demand_week):
    if (product == 'ORA'):
        return None
...
def get_purchase_week(product, demand_week):
#    if (product == 'ORA'):
